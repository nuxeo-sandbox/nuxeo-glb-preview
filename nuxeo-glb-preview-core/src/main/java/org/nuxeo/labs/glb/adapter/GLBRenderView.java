...
public class GLBRenderView {
    ...
    public GLBRenderView(String name, Blob content) {
        this.name = name;
        this.content = content;
    }

    public GLBRenderView(Map<String, Serializable> map) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GLBRenderView)) return false;
        GLBRenderView that = (GLBRenderView) o;
